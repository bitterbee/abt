...
public class CSSNode {
  ...
  /*package*/ final CSSStyle style = new CSSStyle();
    ...
    protected @Nullable ArrayList<CSSNode> mChildren;
    ...
    public void setStyleMinWidth(float width) {
        if (!valuesEqual(style.minWidth, width)) {
    ...
    public void setStyleMinHeight(float height) {
        if (!valuesEqual(style.minHeight, height)) {
    ...
    public void setStyleMaxWidth(float width) {
        if (!valuesEqual(style.maxWidth, width)) {
    ...
    public void setStyleMaxHeight(float height) {
        if (!valuesEqual(style.maxHeight, height)) {
    ...
    public void setNoDirtyStyleWidth(float width) {
        if (!valuesEqual(style.dimensions[DIMENSION_WIDTH], width)) {
            style.dimensions[DIMENSION_WIDTH] = width;
        }
    }

    public void setNoDirtyStyleHeight(float height) {
